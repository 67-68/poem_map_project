...
func setup_visuals(level: int, text_content: String):
	...
	match level:
		...
		3: # L3
			...
			rich.text = "[shake rate=20 level=5][color=red]%s[/color][/shake]" % text_content
