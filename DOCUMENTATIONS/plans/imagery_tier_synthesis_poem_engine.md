...
在盛唐的政治沙盘里，一首诗的"等级"**绝对不是单维度的**！一首诗写出来，必须产生两个**绝对正交的输出切片 (Orthogonal Outputs)**：

1. **世俗变现值 (Secular Yield)：** 这首诗能换来多少权贵的赏识、多少真金白银、能不能当官？

2. **千古不朽值 (Historical Yield)：** 这首诗在文学史上能留存多久？能引发多少清流的共鸣？
